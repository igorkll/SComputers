...
local renderSettings = {
    ...
    simpleShadowMin = 0.2, --the minimum brightness of an object that a simple shadow can give
    simpleShadowMax = 1.2, --the maximum brightness of an object that a simple shadow can give
    ...
    customTerrainColor_grass = 0x75a80a,
